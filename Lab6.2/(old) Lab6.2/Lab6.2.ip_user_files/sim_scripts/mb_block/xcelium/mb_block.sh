...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../Lab6.2.gen/sources_1/bd/mb_block/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../Lab6.2.gen/sources_1/bd/mb_block/ipshared/7698" \
       +incdir+"../../../../Lab6.2.gen/sources_1/bd/mb_block/ipshared/ec67/hdl" \
       +incdir+"../../../../Lab6.2.gen/sources_1/bd/mb_block/ipshared/7698" \
       -input simulate.do
}
